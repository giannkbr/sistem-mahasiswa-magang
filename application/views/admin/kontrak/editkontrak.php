<div class="row">
	<div class="col-12">
		<div class="card m-b-30">
			<div class="card-body">
				<form action="<?= base_url('Kontrak/editkontrak/' . $data->kontrak_id) ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<div class="list-group">
								...
								<?php else : ?>
									<input type="text" id="kontrak" name="kontrak" class="form-control" value="<?= base_url('kontrak/default.pdf') ?>" placeholder="Data Kontrak">
								<?php endif ?>
							</div>
						</div>
					</div>
